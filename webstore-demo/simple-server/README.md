...
I was using [Python](https://www.python.org/) 3.6.6 on Ubuntu18 when implementing this Simple Server. I used Python virtual environment to keep my Ubuntu installation clean:
...
I decided to use [Flask](http://flask.pocoo.org/) (version 1.0.2) since it is widely-used Python microframework. 
